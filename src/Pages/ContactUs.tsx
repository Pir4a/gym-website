...
function ContactUs() {
  return (
    <>
      ...
      <div className="flex flex-col py-16 gap-4 font-Montserrat">
        ...
        <div className="flex flex-col px-4">
          ...
          <div className="flex flex-col">
            ...
            <p className="pt-4 pb-8 opacity-80 flex gap-4">
              <FaFacebook className="size-6" /> <FaTwitter className="size-6" />{" "}
              <FaInstagram className="size-6" /> <FaTiktok className="size-6" />
            </p>
          </div>
        </div>
      </div>
      <div className="flex flex-col items-center mx-auto w-">
        <form className="w-11/12 bg-neutral-100 flex flex-col items-center py-8 gap-4">
          ...
          />
          <input type="email" placeholder="Email" className="w-3/4 p-3 mt-2" />
